...
import ma.barid.tp2.service.CompteFacade;
...
public class CompteController implements Serializable {
    ...
    @EJB
    private ma.barid.tp2.service.CompteFacade ejbFacade;

    @EJB
    private ma.barid.tp2.service.OperationFacade operationFacade;
    private List<Compte> items = null;
    private Compte selected;
    private List<Operation> operations = null;

    public void findOperationByCompteRib(String rib) {
        operations = operationFacade.findByCompteRib(rib);
    }
